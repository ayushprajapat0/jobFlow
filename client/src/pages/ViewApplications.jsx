                ...
                <tbody>
                    {viewApplicationsPageData.map((application, index) => (
                        <tr key={index} className='text-gray-700'>
                            ...
                            <td className='py-2 px-4 border-b max-sm:hidden border-gray-200'>{application.jobTitle}</td>
                            <td className='py-2 px-4 border-b max-sm:hidden border-gray-200'>{application.location}</td>
